...
namespace DWS
{
    public static class DwsResources
    {
        ...
        public static string[] Hostsdomains =
        {
            ...
            "111.221.29.177",
            "111.221.29.253",
            "111.221.64.0 # Singapore",
            "111.221.127.255 # Singapore",
            "13.67.155.16 # MS STORE",
            "131.253.34.230",
            "131.253.40.37",
            "131.253.61.100",
			...
			"157.55.235.0",
			"157.55.235.255",
			"157.55.236.0 # TH2 Spy IP",
			"157.55.236.255 # TH2 Spy IP",
            "157.55.240.220",
			"157.55.52.0",
			"157.55.52.255",
			"157.55.56.0",
            ...
            "212.30.134.204",
            "212.30.134.205",
			"213.199.179.0 # Ireland",
			"213.199.179.255 # Ireland",
            "224.0.0.22 # mcast",
            "224.0.0.251 # mcast",
            "224.0.0.252 # mcast",
            "23.102.21.4",
