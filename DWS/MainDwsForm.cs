...
Are you sure?", @"Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
        ...
        private void SetLanguage(string currentlang = null)
        {
            ...
            if (currentlang.IndexOf("hk", StringComparison.Ordinal) > -1)
            {
                _rm = zh_HK.ResourceManager; // change resource language manager.
                comboBoxLanguageSelect.Text = @"zh-HK | 正體中文"; // set combobox text language.
            }
